...
public class AdjGraphTests
{

    DGraphAL<int> dgInts;
    UGraphAL<string> ugStrings;

    [SetUp]
    public void Setup()
    {
        dgInts = new DGraphAL<int>();
        dgInts.AddVertex(10);
        dgInts.AddVertex(11);
        dgInts.AddVertex(12);
        dgInts.AddVertex(13);
    ...
    public void TestUGMMinimumSpanningTree()
    {
        ...
        UGraphAL<string> ugMST =
            (UGraphAL<string>)ugStrings.MinimumSpanningTree();
    ...
    public void TestUGMergeGraphs()
    {
        ...
        UGraphAL<string> ugMore = new UGraphAL<string>();
        ugMore.AddVertex("M");
        ugMore.AddVertex("N");
...
public class AdjGraphClassTests
{
    DGraphAL<string> dgmString;
    UGraphAL<string> ugmString;

    [SetUp]
    public void Setup()
    {
        dgmString = new DGraphAL<string>();
        ugmString = new UGraphAL<string>();
    }
